...
import { increaseQuantity } from "../redux/slice";
      ...
      <div className="flex flex-col md:flex-row w-screen h-full px-14 py-7 container mx-auto">
        <div className="w-full flex flex-col h-fit gap-4 p-4">
          ...
          {products.map((product, ind) => (
            <div className="flex flex-col p-4 text-lg font-semibold shadow-md border rounded-sm" key={ind}>
              ...
              <div className="flex flex-row self-center gap-1">
                <button className="w-5 h-5 self-center rounded-full inline-flex items-center justify-center  border border-gray-300">
                  -
                </button>
                <input
                  type="text"
                ...
                />
                <button onClick={() => dispatch(increaseQuantity(product))} className="w-5 h-5 self-center inline-flex justify-center items-center rounded-full border border-gray-300">
                  +
                </button>
              </div>
            </div>
